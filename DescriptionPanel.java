...
super(new MigLayout("filly","[][grow][]"));
		...
		add(new JLabel("Description Title (optional) "), "right");
		...
		JButton btnClear = new JButton("Cancel/Clear Description Text");
		add(btnClear, "wrap");
		...
		JButton btnNew = new JButton("Add Another Description");
		add(btnNew);
